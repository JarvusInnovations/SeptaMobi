                                            ...
                                            '<tpl for="steps">',
                                                '<li class="leg-step">',
                                                    '<span class="step-direction">',
                                                        '<tpl if="relativeDirection">',
                                                            '{[values.relativeDirection == "DEPART" ? "Depart " + SeptaMobi.strings.TripPlanner.directions[values.absoluteDirection.toLowerCase()] : SeptaMobi.strings.TripPlanner.directions[values.relativeDirection.toLowerCase()]]}',
                                                        '</tpl>',
                                                    '</span> ',
