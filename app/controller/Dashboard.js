Ext.define('SeptaMobi.controller.Dashboard', {
	...
	config: {
		refs: {
			...
			bookmarkList: 'dashboard #bookmarkslist'
		},
		...
		control: {
			...
			dashboardView: {
				activate: 'onDashboardViewActivate'
			}
		}
	},
	...
	launch: function() {
		...
		window.twitterFetcher = function() {
			function x(e) {
		...
		var handleTweets = function(tweets) {
			me.getDashboardView().setTweets(tweets);
		};

		window.twitterFetcher.fetch('393864883231404032', '', 15, true, true, true, '', false, handleTweets, false);
	},
	...
	onDashboardViewActivate: function() {
		this.getBookmarkList().deselectAll();
	}
